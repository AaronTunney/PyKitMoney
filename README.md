...
1. A [Raspberry Pi Zero 2 W (with header)](https://thepihut.com/products/raspberry-pi-zero-2?variant=43855634497731). I've also got this project working with the original Raspberry Pi Zero WH model but I had to install the _legacy_ 32-bit version of Raspberry Pi OS and spend more time getting the Python depedencies to work. I would recommending using a Raspberry Pi Zero 2 unless you already have an original Pi Zero gathering dust and also have a significant amount of patience.
